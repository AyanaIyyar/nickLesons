...
if ($result->num_rows > 0)
{
    while ($row=$result->fetch_assoc())
    {
        ...
        <hr>
        <div class="heading">
            <h3 class="text-center">Delete Personal Details</h3>
        </div>
        <hr>
        <div class="container">
            <form action="deletePerson.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <br>
                        <input type="email" name="emailAddress" class="form-control" placeholder="* email Here" required value="<?php echo $row['email'];?>">
                        <br>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <br>
                        <input type="text" name="nextOfKin" class="form-control" placeholder="* Next of Kin Here" required value="<?php echo $row['nok'];?>">
                        <br>
                    </div>
                    <div class="col-sm-4">
